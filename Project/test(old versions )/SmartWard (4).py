...
class Ui_MainWindow(object):
    ...
    def refertohome(self):###refers to home page
        ...
        self.stackedWidget.setStyleSheet("background-image: url(background.png);")
    ...
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(0, 0, 819, 490))
        self.stackedWidget.setStyleSheet("background-image: url(background.png);")
        ...
        self.loginpage_refer_fromhome.setGeometry(QtCore.QRect(90, 430, 200, 41))
        self.loginpage_refer_fromhome.setStyleSheet("color:white;\n"
"font-size:20px;\n""background:qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(0, 0, 0, 255), stop:0.05 rgba(14, 8, 73, 255), stop:0.36 rgba(28, 17, 145, 255), stop:0.6 rgba(126, 14, 81, 255), stop:0.75 rgba(234, 11, 11, 255), stop:0.79 rgba(244, 70, 5, 255), stop:0.86 rgba(255, 136, 0, 255), stop:0.935 rgba(239, 236, 55, 255));")
        ...
        self.signuppage_refer_fromhome.setGeometry(QtCore.QRect(300, 430, 200, 41))
...
"font-size:20px;\n""background:qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(0, 0, 0, 255), stop:0.05 rgba(14, 8, 73, 255), stop:0.36 rgba(28, 17, 145, 255), stop:0.6 rgba(126, 14, 81, 255), stop:0.75 rgba(234, 11, 11, 255), stop:0.79 rgba(244, 70, 5, 255), stop:0.86 rgba(255, 136, 0, 255), stop:0.935 rgba(239, 236, 55, 255));")
        ...
        self.exit_from_home.setGeometry(QtCore.QRect(510, 430, 200, 41))
...
"")
        ...
        self.Welcome_label.setGeometry(QtCore.QRect(145, 30, 370, 61))
        font = QtGui.QFont()
        font.setFamily("Consolas")
...
"")
        ...
        self.Welcome_label_admin.setGeometry(QtCore.QRect(145, 30, 390, 61))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(18)
...
"color:black;")
        ...
        self.logout_from_adminpage.setGeometry(QtCore.QRect(465, 440, 101, 41))
...
"")
        ...
        self.exit_from_adminpage.setGeometry(QtCore.QRect(570, 440, 101, 41))
