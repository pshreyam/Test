...
"")
        ...
        #############################################################################
        ####show password#############################################################
        self.show_password_login=QtWidgets.QPushButton(self.signin_groupbox)
        self.show_password_login.setGeometry(QtCore.QRect(382,160,101,41))
        self.show_password_login.setStyleSheet("border-radius:20px;\n"
"color:black;\n"
"background:red;\n"
"font-family:Consolas;\n"
"font-size:20px;\n"
...
"\n"
"")
        self.show_password_login.setText("Show")
        self.show_password_login.clicked.connect(self.show_password)
        ##############################################################################
        #####hide password############################################################
        self.hide_password_login=QtWidgets.QPushButton(self.signin_groupbox)
        self.hide_password_login.setGeometry(QtCore.QRect(382,202,101,41))
        self.hide_password_login.setStyleSheet("border-radius:20px;\n"
"color:black;\n"
"background:red;\n"
"font-family:Consolas;\n"
"font-size:20px;\n"
...
"\n"
"")
        self.hide_password_login.setText("Hide")
        self.hide_password_login.clicked.connect(self.hide_password)
        ###########################################################################
